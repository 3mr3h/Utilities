'''web_crawler_example.py
@author: Emre Hosgor
Description: A small, easy to follow, web crawler to support my research.
If performs okay, will include my research.'''

# pip install httpx parsel w3lib tldextract loguru
# alternative
# pip install requests beautifulsoup w3lib tldextract loguru
